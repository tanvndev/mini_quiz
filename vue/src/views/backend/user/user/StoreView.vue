                    ...
                    <a-row :gutter="16">
                            ...
                            <a-card class="mt-3" title="Thông tin chung">
                                ...
                                <a-row :gutter="[16, 16]">
                                    ...
                                    <a-col :span="12" v-if="!id">
                                        <InputComponent type="password" label="Mật khẩu" :required="true"
                                            name="password" />
                                    </a-col>

                                    <a-col :span="12">
                                        <SelectComponent label="Nhóm thành viên" name="user_catalogue_id"
                                            placeholder="Chọn nhóm thành viên" :options="state.userCatalogues"
                                            :required="true" />
                                    </a-col>
                                    <a-col :span="!id ? 12 : 24">
                                        <label for="image" class="mb-2 block text-sm font-medium text-gray-900">Ảnh đại
                                            diện</label>
                        ...
                        <a-col :span="12">
                            <a-card class="mt-3" title="Địa chỉ">
                                ...
                                <a-row :gutter="[16, 15]">
                                    <a-col :span="8">
                                        <SelectComponent label="Quận/Thành phố" name="province_id"
                                            placeholder="Chọn Tỉnh/Thành phố" :options="provinces"
                                            @onChange="getLocation('districts', $event)" />
                                    </a-col>

                                    <a-col :span="8">
                                        <SelectComponent label="Quận/Huyện" name="district_id"
                                            placeholder="Chọn Quận/Huyện" :options="districts"
                                            @onChange="getLocation('wards', $event)" />
                                    </a-col>

                                    <a-col :span="8">
                                        <SelectComponent label="Phường/Xã" name="ward_id" placeholder="Chọn Phường/Xã"
                                            :options="wards" />
                                    </a-col>
